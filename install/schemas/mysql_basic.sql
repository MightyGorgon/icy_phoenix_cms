...
## Roll on version
INSERT INTO `phpbb_config` (`config_name`, `config_value`) VALUES ('version', '1.0.0');
...
INSERT INTO `phpbb_cms_block_settings` (`bs_id`, `user_id`, `name`, `content`, `blockfile`, `view`, `type`, `groups`, `locked`) VALUES(1, 0, 'Welcome', 'Welcome To <b>Icy Phoenix</b>', '', 0, 0, '', 1);
INSERT INTO `phpbb_cms_block_settings` (`bs_id`, `user_id`, `name`, `content`, `blockfile`, `view`, `type`, `groups`, `locked`) VALUES(2, 0, 'Welcome', '<table class="empty-table" width="100%" cellspacing="0" cellpadding="0" border="0">\r\n	<tr>\r\n		<td width="5%"><img src="images/icy_phoenix_small.png" alt="" /></td>\r\n		<td width="90%" align="center"><div class="post-text">Welcome To <b>Icy Phoenix</b></div><br /><br /></td>\r\n		<td width="5%"><img src="images/icy_phoenix_small_l.png" alt="" /></td>\r\n	</tr>\r\n</table>', '', 0, 0, '', 1);
...
INSERT INTO `phpbb_cms_blocks` (`bid`, `bs_id`, `block_cms_id`, `layout`, `layout_special`, `title`, `bposition`, `weight`, `active`, `border`, `titlebar`, `background`, `local`) VALUES(1, 1, 0, 1, 0, 'Welcome', 'l', 1, 1, 1, 1, 1, 1);
INSERT INTO `phpbb_cms_blocks` (`bid`, `bs_id`, `block_cms_id`, `layout`, `layout_special`, `title`, `bposition`, `weight`, `active`, `border`, `titlebar`, `background`, `local`) VALUES(2, 2, 0, 1, 0, 'Welcome', 'c', 1, 1, 1, 1, 1, 1);
...
INSERT INTO `phpbb_cms_layout` (`lid`, `name`, `filename`, `template`, `layout_cms_id`, `global_blocks`, `page_nav`, `config_vars`, `view`, `groups`) VALUES(1, '2 Columns', '', '2_column.tpl', 0, 0, 1, '', 0, '');


## `phpbb_config`
##

INSERT INTO `phpbb_config` (`config_name`, `config_value`) VALUES ('site_disable', '0');
...
## `phpbb_users`
##
INSERT INTO `phpbb_users` (`user_id`, `user_active`, `user_mask`, `user_cms_auth`, `user_permissions`, `user_perm_from`, `username`, `username_clean`, `user_first_name`, `user_last_name`, `user_password`, `user_newpasswd`, `user_passchg`, `user_form_salt`, `user_session_time`, `user_session_page`, `user_browser`, `user_lastvisit`, `user_regdate`, `user_type`, `user_level`, `user_posts`, `user_timezone`, `user_style`, `user_lang`, `user_dateformat`, `user_private_chat_alert`, `user_emailtime`, `user_options`, `user_allow_mass_email`, `user_notify`, `user_rank`, `user_avatar`, `user_avatar_type`, `user_email`, `user_email_hash`, `user_website`, `user_from`, `user_sig`, `user_aim`, `user_facebook`, `user_flickr`, `user_googleplus`, `user_icq`, `user_jabber`, `user_linkedin`, `user_msnm`, `user_twitter`, `user_skype`, `user_yim`, `user_youtube`, `user_occ`, `user_interests`, `user_actkey`, `user_birthday_y`, `user_birthday_m`, `user_birthday_d`, `user_color_group`, `user_color`, `user_gender`, `user_totaltime`, `user_totallogon`, `user_totalpages`, `user_time_mode`, `user_dst_time_lag`, `user_registered_ip`, `user_registered_hostname`, `user_topics_per_page`, `user_posts_per_page`, `user_login_attempts`, `user_last_login_attempt`, `user_from_flag`, `user_phone`, `user_selfdes`) VALUES
(-1, 0, 0, '', '', 0, 'Anonymous', 'anonymous', '', '', '', '', 0, '', 0, '0', '', 0, 0, 0, 0, 0, 0.00, NULL, '', '', '0', 0, 895, 1, 0, NULL, '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, 0, 0, 0, 2, 60, '', '', '50', '15', 0, 0, '', '', '');
INSERT INTO `phpbb_users` (`user_id`, `user_active`, `user_mask`, `user_cms_auth`, `user_permissions`, `user_perm_from`, `username`, `username_clean`, `user_first_name`, `user_last_name`, `user_password`, `user_newpasswd`, `user_passchg`, `user_form_salt`, `user_session_time`, `user_session_page`, `user_browser`, `user_lastvisit`, `user_regdate`, `user_type`, `user_level`, `user_posts`, `user_timezone`, `user_style`, `user_lang`, `user_dateformat`, `user_private_chat_alert`, `user_emailtime`, `user_options`, `user_allow_mass_email`, `user_notify`, `user_rank`, `user_avatar`, `user_avatar_type`, `user_email`, `user_email_hash`, `user_website`, `user_from`, `user_sig`, `user_aim`, `user_facebook`, `user_flickr`, `user_googleplus`, `user_icq`, `user_jabber`, `user_linkedin`, `user_msnm`, `user_twitter`, `user_skype`, `user_yim`, `user_youtube`, `user_occ`, `user_interests`, `user_actkey`, `user_birthday_y`, `user_birthday_m`, `user_birthday_d`, `user_color_group`, `user_color`, `user_gender`, `user_totaltime`, `user_totallogon`, `user_totalpages`, `user_time_mode`, `user_dst_time_lag`, `user_registered_ip`, `user_registered_hostname`, `user_topics_per_page`, `user_posts_per_page`, `user_login_attempts`, `user_last_login_attempt`, `user_from_flag`, `user_phone`, `user_selfdes`) VALUES
(2, 1, 0, '', '', 0, 'Admin', 'admin', '', '', '21232f297a57a5a743894a0e4a801fc3', '', 0, '', 0, '0', '', 0, 0, 0, 1, 2, 0.00, 1, 'english', 'd M Y h:i a', '0', NULL, 895, 1, 0, 1, '', 0, 'admin@yourdomain.com', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 3, '#dd2222', 0, 0, 0, 0, 2, 60, '', '', '50', '15', 0, 0, '', '', '');
