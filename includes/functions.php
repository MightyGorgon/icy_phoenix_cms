...
function empty_cache_folders($cache_folder = '', $files_per_step = 0)
{
	...
	$cache_dirs_array = array(MAIN_CACHE_FOLDER, CMS_CACHE_FOLDER, SQL_CACHE_FOLDER);
...
function page_header($title = '', $parse_template = false)
{
	...
	$nav_cat_desc = '';
	// IP CMS: adjust the function to display page in breadcrumbs
	/*
